      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-500 via-green-500 to-green-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold">Welcome to MangooHost</h1>
            ...
            <div className="flex items-center space-x-2 text-green-100">
              ...
              <span>Be sure to enable 2fa!</span>
            </div>
          </div>

          {/* Bottom Section */}
          <div className="space-y-4">
            <p className="text-green-100">Don't have an account yet?</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-950">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center space-y-4">
            <Badge className="bg-green-600 text-white px-4 py-1">Welcome Back!</Badge>
            <div>
          ...
          <form className="space-y-4">
            ...
            {/* Sign In Button */}
            <Button type="submit" className="w-full bg-green-500 hover:bg-green-600 text-white py-3 font-medium">
              Sign In
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
            ...
            <div className="space-y-3">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full bg-white hover:bg-gray-100 border-gray-300 text-gray-900"
              >
